...
void            GfxVertexArrayDestroy(GfxVertexArray vao);
...
void            GfxDrawArrays(u32 vertexCount);
void            GfxDrawIndexed(u32 indexCount);
